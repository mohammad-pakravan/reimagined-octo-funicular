...
INSERT INTO coin_packages (package_name, coin_amount, price, stars_required, payment_methods_json, is_active, is_visible, display_order)
VALUES 
    ('100 سکه', 100, 10000, 50, '["shaparak", "stars"]', TRUE, TRUE, 1),
    ('500 سکه', 500, 45000, 225, '["shaparak", "stars"]', TRUE, TRUE, 2),
    ('1000 سکه', 1000, 80000, 400, '["shaparak", "stars"]', TRUE, TRUE, 3),
    ('2500 سکه', 2500, 180000, 900, '["shaparak", "stars"]', TRUE, TRUE, 4);
